...
import 'package:unitask/services/subject_api_survice.dart';

final subjectApiServiceProvider = Provider<SubjectApiSurvice>(
  (ref) => SubjectApiSurvice(),
);
...
class SubjectNotifier extends AsyncNotifier<List<Subject>> {
  ...
  SubjectApiSurvice get _api => ref.read(subjectApiServiceProvider);
